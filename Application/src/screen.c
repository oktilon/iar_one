...
#define LCD_RS_SET  rt_pin_write(LCD_RS_PIN, PIN_LOW)       //����Ϊ����ģʽ
#define LCD_RS_CLR  rt_pin_write(LCD_RS_PIN, PIN_HIGH)      //����Ϊ������ģʽ������ģʽ��

#define LCD_RST_SET rt_pin_write(LCD_RESET_PIN, PIN_LOW);   //LCD resetʹ��
#define LCD_RST_CLR rt_pin_write(LCD_RESET_PIN, PIN_HIGH);  //LCD resetȡ��

#define LCD_BACKLIGHT_ON    rt_pin_write(LCD_BACKLIGHT_PIN, PIN_HIGH);      //����LCD����
#define LCD_BACKLIGHT_OFF   rt_pin_write(LCD_BACKLIGHT_PIN, PIN_LOW);       //Ϩ��LCD����
